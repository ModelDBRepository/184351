'''
Current clamp demo using Allen Brain's model 473465774.
...
from neuron473465774 import Neuron473465774
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473465774(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473465774; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.1046676636)
        h.fcurrent()
